...
def promote_employee():
    ...
    if employee:
        ...
        cursor.execute("UPDATE employees SET post = %s WHERE employee_id = %s", (new_post, employee_id))
        db.commit()
...
while True:
        ...
        print("ENTER 2 : SHOW employee")
        print("ENTER 3 : SEARCH employee")
        print("ENTER 4 : UPDATE employee DETAIL")
        print("ENTER 5 : PROMOTE employee")
